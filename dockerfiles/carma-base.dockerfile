...
ADD --chown=carma ${SOURCE_BASE}/package.xml /home/carma/.base-image/workspace/src/carma_base/
ADD --chown=carma ${SOURCE_BASE}/entrypoint.sh /home/carma/.base-image/
ADD --chown=carma ${SOURCE_BASE}/init-env.sh /home/carma/.base-image/
RUN rosdep update && \
...
ADD --chown=carma ${SOURCE_BASE}/code_coverage /home/carma/.ci-image/engineering_tools/code_coverage
