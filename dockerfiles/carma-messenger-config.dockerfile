...
ENV APP_NAME=carma-messenger-config
...
ADD modules/carma-messenger/carma-messenger-config/development/ /root/vehicle/config
COPY ${OVERRIDES_BASE_DIR}/development/ /root/vehicle/config
