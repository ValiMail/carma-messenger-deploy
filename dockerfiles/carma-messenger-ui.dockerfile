...
ENV APP_NAME=carma-messenger-ui
...
COPY --chown=www-data modules/carma-messenger/carma-messenger-ui/website /var/www/html
COPY --chown=www-data ${OVERRIDES_BASE_DIR}/website /var/www/html
ADD ${OVERRIDES_BASE_DIR}docker/install.sh /
